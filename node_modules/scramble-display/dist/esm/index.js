...
import {
  ...
  offsetMod
} from "./chunk-KTP5YOXP.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
  __privateSet
} from "./chunk-VVT7CIBF.js";
...
var TwistyAnimationController = (_a = class {
  constructor(model, delegate) {
    ...
    __privateAdd(this, _animFrameEffectiveTimestampStaleDropper, void 0);
    ...
    __privateSet(this, _animFrameEffectiveTimestampStaleDropper, new StaleDropper());
    this.model = model;
...
var Twisty2DPuzzle = (_a2 = class extends ManagedCustomElement {
  ...
  constructor(model, kpuzzle, svgSource, options, puzzleLoader) {
    super();
    __privateAdd(this, _cachedPosition, void 0);
    __privateAdd(this, _freshListenerManager, void 0);
    this.model = model;
    this.kpuzzle = kpuzzle;
    ...
    __privateSet(this, _cachedPosition, null);
    __privateSet(this, _freshListenerManager, new FreshListenerManager());
...
var TwistyButton = (_a10 = class extends ManagedCustomElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _iconManager, void 0);
    this.htmlButton = document.createElement("button");
    __privateSet(this, _iconManager, new ClassListManager(
      this,
      "svg-",
      buttonIcons
    ));
...
var TwistyPlayer = (_a13 = class extends TwistyPlayerSettable {
  ...
  constructor(config = {}) {
    ...
    __privateAdd(this, _controlsManager, void 0);
    __privateAdd(this, _visualizationWrapperElem, void 0);
    __privateAdd(this, _errorElem, void 0);
    __privateAdd(this, _alreadyConnected, void 0);
    __privateAdd(this, _flashLevel, void 0);
    __privateAdd(this, _visualizationWrapper, void 0);
    __privateAdd(this, _initial3DVisualizationWrapper, void 0);
    __privateAdd(this, _visualizationStrategy, void 0);
    ...
    __privateSet(this, _controlsManager, new ClassListManager(
      this,
      "controls-",
      ["auto"].concat(
    ...
    __privateSet(this, _visualizationWrapperElem, document.createElement("div"));
    __privateSet(this, _errorElem, document.createElement("div"));
    __privateSet(this, _alreadyConnected, false);
    __privateSet(this, _flashLevel, "auto");
    __privateSet(this, _visualizationWrapper, null);
    __privateSet(this, _initial3DVisualizationWrapper, new InitialValueTracker());
    __privateSet(this, _visualizationStrategy, null);
...
var TwistyAlgViewer = (_a14 = class extends HTMLElementShim {
  constructor(options) {
    ...
    __privateAdd(this, _twistyPlayer, void 0);
    this.highlighter = new MoveHighlighter();
    __privateSet(this, _twistyPlayer, null);
...
var TwistyAlgEditor = (_a15 = class extends ManagedCustomElement {
  constructor(options) {
    ...
    __privateAdd(this, _textarea, void 0);
    __privateAdd(this, _carbonCopy, void 0);
    __privateAdd(this, _carbonCopyPrefix, void 0);
    __privateAdd(this, _carbonCopyHighlight, void 0);
    __privateAdd(this, _carbonCopySuffix, void 0);
    __privateAdd(this, _textareaClassListValidForPuzzleManager, void 0);
    __privateAdd(this, _twistyPlayer2, void 0);
    __privateAdd(this, _twistyPlayerProp, void 0);
    __privateAdd(this, _onInputHasFired, void 0);
    __privateAdd(this, _highlightedLeaf, void 0);
    this.model = new TwistyAlgEditorModel();
    __privateSet(this, _textarea, document.createElement("textarea"));
    __privateSet(this, _carbonCopy, document.createElement("div"));
    __privateSet(this, _carbonCopyPrefix, document.createElement("span"));
    __privateSet(this, _carbonCopyHighlight, document.createElement("span"));
    __privateSet(this, _carbonCopySuffix, document.createElement("span"));
    __privateSet(this, _textareaClassListValidForPuzzleManager, new ClassListManager(this, "valid-for-puzzle-", [
      "none",
      "warning",
      "error"
    ]));
    __privateSet(this, _twistyPlayer2, null);
    this.debugNeverRequestTimestamp = false;
    __privateSet(this, _onInputHasFired, false);
    __privateSet(this, _highlightedLeaf, null);
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-QEEUMPT6.js")).getPuzzleDescriptionString(config.puzzle);
...
var ScrambleDisplay = class extends HTMLElement {
  ...
  constructor() {
    ...
    __privateAdd(this, _twistyPlayer3, new TwistyPlayer({
      controlPanel: "none",
      hintFacelets: "none",
      visualization: "2D",
      background: "none"
  ...
  get player() {
    return __privateGet(this, _twistyPlayer3);
  }
  connectedCallback() {
    __privateGet(this, _wrapper).appendChild(__privateGet(this, _twistyPlayer3));
  }
  set event(eventID) {
    const info = eventInfo(eventID ?? DEFAULT_EVENT);
    __privateGet(this, _twistyPlayer3).puzzle = info?.puzzleID ?? "3x3x3";
  ...
  set scramble(scramble) {
    ...
    __privateGet(this, _twistyPlayer3).alg = alg;
  ...
  set visualization(visualization) {
    __privateGet(this, _twistyPlayer3).visualization = visualization ?? "2D";
  ...
  set checkered(checkered) {
    ...
    __privateGet(this, _twistyPlayer3).background = checkeredBoolean ? "checkered" : "none";
