...
var cube3x3x3 = {
  ...
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-JFZVE27C.js")).cube3x3x3SVG;
  }),
  llSVG: getCached(async () => {
    return (await import("./puzzles-dynamic-3x3x3-JFZVE27C.js")).cube3x3x3LLSVG;
  }),
  pg: getCached(async () => {
...
var MegaminxPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    this.llSVG = getCached(async () => {
      return (await import("./puzzles-dynamic-megaminx-QQYC32WM.js")).megaminxLLSVG;
    });
  }
  stickeringMask(stickering) {
...
//# sourceMappingURL=chunk-AU3TSTCA.js.map
